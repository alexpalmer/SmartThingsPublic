...
def ELKpref() {
	return dynamicPage(name:"ELKpref", title:"ELK Integration", install:false, uninstall: true) {
        section("ELK Area/Zones") {
...
def nodePage() {
    ...
    return dynamicPage(name:"nodePage", title:"Node Selection", nextPage:"", refreshInterval: refreshInterval, install:true, uninstall: true) {
        ...
        section("ELK Integration?"){
        	href "ELKpref", title: "ELK Integration", required: false
        }
    }
}
